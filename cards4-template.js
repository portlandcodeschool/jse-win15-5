...
//-----------------------
    ...
    function shortName() {
       //var myVariable = document.getElementById('myElement');
        var arr= this.cardName().split(' ')
        var shortText = arr[0].charAt(0) + arr[2].charAt(0);
          return shortText//myVariable.innerHTML = shortText
      
    };
      
    function renderText(cell) {
      var myVariable = document.getElementById('myElement');
      return myVariable.innerHTML = this.shortName();
    };
...
//var cnn = makeCard.cardName();
//myVariable.innerHTML = cnn()//shortcard

var card0 = makeCard(4);
card0.renderText();
